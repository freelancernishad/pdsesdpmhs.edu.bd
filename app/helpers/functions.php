...
function sitedetails()
{
    ...
    $count = DB::table('school_details')->where('school_id', '136045')->count();
    if ($count > 0) {
        return  $data = DB::table('school_details')->where('school_id', '136045')->first();
...
$Fgg = 0;
    ...
    foreach ($subjects as $sub) {
        ...
        elseif ($class == "Eight") {
            ...
            //  array_push($greating,[subjectCol($sub)=>$gread1]);
            ...
            //             } else {
                            ...
                            $great = Greeting($subMark, $SUBJECT_TOTAL, 'greed');
                            array_push($greating, $great);
                            // array_push($greating,[subjectCol($sub)=>$great]);
    ...
    <table width='100%' style='margin-bottom:$marginBottom' border='0'>
        <tr>
            ...
            <td style='border:0 !important'>
                ...
                <p class='fontsize1' style='font-size:12px'>website: $schoolDetails->school_domain </p>
            </td>
